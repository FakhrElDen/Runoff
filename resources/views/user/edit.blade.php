...
<body>
    <form class="formgroup" enctype="multipart/form-data"  method="POST" action="http://localhost/football/public/UpdateUser/{{$user->id}}">
        {{ @csrf_field() }}
        <fieldset>
            <div class="container col-sm-offset-4 col-sm-4">
                <h1>Edit Your Info</h1><hr>
                ...
                <div class="input-group input-group-lg">
                    ...
                    <input type="textarea" class="form-control" id="password" name="password" value=" " pattern=".{6,}" title="Six or more characters">
                </div><br><br>
                ...
                <div class="input-group input-group-lg">
                    ...
                    <input type="textarea" class="form-control" id="confirm_password">
                </div><br><br>
                ...
                <input type="submit" class="btn btn-success btn-block" style="font-weight: bold;" value="Edit User"><hr><br>
            </div>
            <script>
