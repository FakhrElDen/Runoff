...
<body>
    <form method="POST" action="http://localhost/football/public/admin/adminLogin " style="color:#555;">
        {{ @csrf_field() }}
        <fieldset>
            <div class="container col-sm-offset-4 col-sm-4">
                ...
                <div class="input-group input-group-lg">
                    ...
                    <input id="password" type="password" placeholder="Enter Password" class="form-control" name="psw" required>
                </div><br><br>
